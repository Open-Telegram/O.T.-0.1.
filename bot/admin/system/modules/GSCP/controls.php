...
class TListControl extends TOnwedControl {
  ...
  protected $itemtag2;  //for DL only, DD
  protected $type;      //0 = UL, 1 = OL , 2 = DL, 3 = not a HTML list, text separator is used
  protected $separator; //for 3 ((pseudo-list) type
  ...
  public function SetType($type, $sep = "") {
    ...
    $this->separator = $sep;
    switch ($this->type) {
      case 0: $this->tag = "ul"; $this->itemtag = "li"; break;
      case 1: $this->tag = "ol"; $this->itemtag = "li"; break;
      case 2: $this->tag = "dl"; $this->itemtag = "dt"; $this->itemtag2 = "dd"; break;
      case 3: $this->tag = "div"; $this->itemtag = ""; $this->itemtag2 = ""; 
    }
  } 
  ...
  public function AddItems($texts = array(), $texts2 = array(), $urls = array()) {
    ...
    foreach ($texts as $txt) {
      ...
      if (isset($urls[$i])) $u = $urls2[$i]; else $u = "";
      $this->AddItem($s,$s2,$u);
      $i++;
    }
  }
